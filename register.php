...
<body>
	...
	<form action = "register.php" method = "post" enctype="multipart/form-data">
		<table>
		<tr><td class = "t_tabula">Vārds:</td><td><input type = "text"  name = "vards" required></td></tr>
		<tr><td class = "t_tabula">Uzvārds:</td><td><input type = "text"  name = "uzvards" required></td></tr>
		...
		<tr><td class = "t_tabula">Atkārtot paroli:</td><td><input type = "password" name = "parole2" required/></td></tr>
		<tr><td class = "t_tabula">Epasts:</td><td><input type = "email" name = "epasts" required /></td></tr>
	...
	$lalei = new database();
	$lalei->reg($_POST["vards"],$_POST["uzvards"],$_POST["lietotajvards"],$_POST["parole1"],$_POST["parole2"],$_POST["epasts"]);
