	...
	<header class = "row">
		...
		<main class="col-md-8">
		  ...
		  <article class="video">
              ...
              <iframe style="margin-top: 10px; margin-bottom: 10px;  padding-left: 45px;  padding-right: 45px; max-width: 100%; height: auto;" src="https://www.youtube.com/embed/Mbn2NWfHY5Q" frameborder="0" allowfullscreen></iframe>
		      <iframe style="margin-top: 10px; margin-bottom: 10px;  padding-left: 45px;  padding-right: 45px;  max-width: 100%; height: auto;" src="https://www.youtube.com/embed/SxIeXCvJu-w" frameborder="0" allowfullscreen></iframe>
		      <iframe style="margin-top: 10px; margin-bottom: 10px;  padding-left: 45px;  padding-right: 45px;  max-width: 100%; height: auto;" src="https://www.youtube.com/embed/CkEowmI7a3w" frameborder="0" allowfullscreen></iframe>
		      <iframe style="margin-top: 10px; margin-bottom: 10px;  padding-left: 45px;  padding-right: 45px;  max-width: 100%; height: auto;" src="https://www.youtube.com/embed/fzN2GXZeFXc" frameborder="0" allowfullscreen></iframe>
